...
const ITEMS = [
  ...
  { icon: CreditCard, value: '03', label: 'Secure deposits', detail: 'Lash lift deposits are non-refundable. Patch test attendance deposits are refunded once you attend.' },
