...
VALUES
  ...
  ('Korean Lash Lift - Mobile Outcall', 'korean-lash-lift-mobile', 'Luxury brings itself to you. Our mobile Korean lash lift service offers the same premium treatment in the comfort of your own home. Includes full setup of professional equipment, consultation, and aftercare guidance. After booking, please message Hauslash on Instagram with your location and treatment address. Travel available throughout Stoke-on-Trent and surrounding areas.', 90, 5000, 1500, 2, true),
  ('Patch Test', 'patch-test', 'A quick consultation and patch test for first-time Hauslash clients. Results are known after 24 hours, so please book this at least 24 hours before your lash lift appointment.', 15, 0, 0, 3, true);
